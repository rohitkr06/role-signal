...
This Manifest V3 Chrome extension fills only evidence-backed fields from a RoleSignal application packet.
...
The companion is intentionally host-locked, flags unknown required fields, never bypasses CAPTCHAs, and never clicks final submit.
